...
import {
  ...
  openImportDockerModal,
  closeImportDockerModal,
  onImportDockerSelectChange,
  submitImportDocker,
  loadVolumes,
  openAddVolumeModal,
  closeAddVolumeModal,
...
import {
  ...
  submitMachineProxy,
  openIsoLibraryModal,
  closeIsoLibraryModal,
  loadIsoList,
  renderIsoRows,
  filterIsoTable,
  triggerIsoFileUpload,
  handleIsoFileUpload,
  submitAddIso,
  openEditIsoModal,
  closeEditIsoModal,
  ...
  closeAttachIsoModal,
  submitAttachIso,
  detachIsoFromMachine,
  deleteIso,
  openSnapshotManagerModal,
  closeSnapshotManagerModal,
  loadSnapshotsForMachine,
  submitCreateSnapshotModal,
  restoreSnapshot,
  deleteSnapshot,
